...
from app.schemas import AlbumOut, ArtistOut, SearchOut, SuggestOut
...
async def search_albums(claims: Claims, session: SessionDep, q: Q) -> list[AlbumOut]:
    """Albums matching what was typed, so a record name is a way in as well."""
    return await library.search_albums(session, q, claims.lang)
