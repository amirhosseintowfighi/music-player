...
**چه چیزی سریع‌تر نمی‌شود:** پخش. resolve و استریم همیشه از `edge` اول می‌روند
(`EDGE_INTERNAL_URL`), و این عمدی است: اکانتی که کرال می‌کند نباید همان اکانتی باشد
که پخش کاربر به آن وابسته است.
