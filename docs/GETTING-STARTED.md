...
**کانالی که پیش‌نمایش ندارد چه؟** دو راه بیشتر نیست: یا ربات را در آن کانال ادمین
کنی (مسیر B — فقط پست‌های جدید می‌آیند، آرشیو قدیمی نه، چون Bot API تاریخچه نمی‌دهد)،
یا رهایش کنی. صف کاندیداها خودش این تشخیص را می‌دهد: هر کاندیدی که probe شود و
